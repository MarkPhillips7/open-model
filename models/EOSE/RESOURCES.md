...
| MWh shipped - Derived from PTC | Formula: statutory PTC $M × 1000 / $45 per kWh (cell+module). Q2 2025 **112.6**; Q2 2026 **307.6** | — |
...
Fully diluted shares is **basic WAS + all potential shares** in that period's EPS footnote (converts, warrants, Series B preferred, RSUs/options). GAAP diluted WAS equals basic in a **loss** quarter (anti-dilutive), so copying XBRL diluted WAS made the row jump 436 → 238 → 272 → 308 → 545 and left Q2 2026 blank. Q1 2025 and Q1 2026 were GAAP-profit quarters (FV marks); those diluted WAS prints are the starting point, then leftover anti-dilutive shares are added. Q2 2026 = 339.799 + 263.131 = **602.930**.

| Period | Basic WAS | GAAP diluted WAS | If-converted fully diluted (sheet) |
| --- | --- | --- | --- |
| Q1 2025 | 225.474 | 436.368 | **466.742** (diluted + 30.374 excluded) |
| Q2 2025 | 237.741 | 237.741 | **533.668** (basic + anti-dilutive) |
| Q3 2025 | 271.618 | 271.618 | **552.574** |
| Q4 2025 | 307.664 | 307.664 | **527.998** (Q4 WAS + FY 10-K anti-dilutive; convert line is 11.1M after the $200M May-note retirement — November 2025 convert is not in that 10-K line) |
| Q1 2026 | 339.602 | 544.829 | **546.671** (diluted + 1.842 excluded) |
| Q2 2026 | 339.799 | 339.799 | **602.930** |

### Earnings used for Actual rows (through Q2 2026)

| Period | 10-Q / 10-K | Earnings 8-K / IR | Figures used |
| --- | --- | --- | --- |
| Q1 2025 | [10-Q](https://www.sec.gov/Archives/edgar/data/1805077/000180507725000051/eose-20250331.htm) | [release](https://investors.eose.com/node/11541/pdf) / [slides](https://investors.eose.com/static-files/37bf65c1-0b9f-409a-8a14-4e02c51038cb) | Rev $10.457M, GP −$24.539M, adj. GP **−$21.125M** (from [Q1 2026 8-K](https://investors.eose.com/news-releases/news-release-details/eos-energy-enterprises-reports-first-quarter-2026-financial) YoY recon: +SBC $1.020M + D&A $2.394M in COGS), adj. EBITDA **−$43.238M** (recon, not a residual), NI +$15.136M, cash $111.694M, pipeline $15.6B / 60 GWh, backlog $680.9M / 2.6 GWh, bookings **$9.2M**, basic WAS 225.474M / if-converted FD 466.742M |
...
4. Patch [`actuals.py`](actuals.py) (sheet units: $M, pipeline $B, shares million). Copy **Production Tax Credits** from the 10-Q 45X footnote (three-month COGS reduction). **MWh shipped - Derived from PTC** / **Unit COGS - Derived** compute from it. Do not invent a Cube vs Indensity split.
5. **Fully diluted shares:** do not paste GAAP diluted WAS. Add the EPS-footnote potential shares (including anti-dilutive) to basic WAS.
6. `python models/EOSE/scripts/load_quarterly_actuals.py`
7. Update **As of date** (column C) so years-from-present and PV stay current.
8. Confirm 45X still treated as a COGS offset in the 10-Q.
9. Add share events on **Shares** if the diluted count jumped for a stated reason.
10. Append sheet edits to [CHANGELOG.md](CHANGELOG.md).
11. `python scripts/sync_repo_from_live_sheet.py --ticker EOSE --update-snapshot` if you typed prints in the sheet first.
